/*
Esse código apresenta o uso da Busca Sequencial ao procurar uma chave dentro de uma tabela desordenada com o 
auxílio de um sentinela.
...
int pesquisa(registro *tabela, int chave){
    int i;
    tabela[tamanho].matricula = chave;

    for (i = 0; chave != tabela[i].matricula; i++);
